 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Nicholas Stoltzfus");
		  toPrint += p1.toString("nstoltzfus3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Siwei Li");
		  toPrint += p2.toString("sli474");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Theresa Ming");
		  toPrint += p3.toString("tming6");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Yuchen Cao");
          toPrint += p4.toString("ycao309");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Yuxin Zheng");
          toPrint += p5.toString("yzheng347");
